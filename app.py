...
data_folder = os.path.join(server.root_path, 'data')

df = pd.read_csv(os.path.join(data_folder, 'df_sem_pendentes_number.csv'))
# time_series = pd.read_csv('serie_nota_RAD_row_2017-2022.csv')
time_series = pd.read_csv(os.path.join(data_folder, 'serie_nota_RAD_row_(2017-2022)-sem-NaN.csv'))
...
def create_dash_application(flask_app):
    app = dash.Dash(server=flask_app, name="Dashboard", url_base_pathname="/dash/", use_pages=True, pages_folder="")
